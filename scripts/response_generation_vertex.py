...
def process_single_query(
    ...
    prompt_input = build_messages(system_prompt, query_text, payloads)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--company", required=True, help="Company name, matching .txt prompt and .jsonl query file")
    parser.add_argument(
        "--query_type",
        required=True,
    ...
    parser.add_argument("--temperature", type=float, default=1.0, help="Sampling temperature for model")
